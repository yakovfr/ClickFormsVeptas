'REV00397.vbs AI Summary Land Appraisal Reviewer Script
...
Sub ReviewSubject
   AddTitle String(5, "=") + "AI FORMS LAND SUMMARY: " + IDAISAR + String(5, "=")
...
Sub ReviewREID
   AddTitle String(5, "=") + "AI FORMS LAND SUMMARY: " + IDAIRE + String(5, "=")
...
Sub ReviewSPH
   AddTitle String(5, "=") + "AI FORMS LAND SUMMARY: " + IDAIPH + String(5, "=")
...
Sub ReviewRC
   AddTitle String(5, "=") + "AI FORMS LAND SUMMARY: " + IDAIRC + String(5, "=")
...
Sub ReviewAP
   AddTitle String(5, "=") + "AI FORMS LAND SUMMARY: " + IDAIAP + String(5, "=")
...
Sub ReviewSW
   AddTitle String(5, "=") + "AI FORMS LAND SUMMARY: " + IDAISW + String(5, "=")
