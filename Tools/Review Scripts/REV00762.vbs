'FM00762.vbs Non-Lender Multi-Unit Extra Comps Reviewer Script
...
Sub ReviewSalesComparison
   AddTitle String(5, "=") + "Non-Lender Multi-Unit Extra Comparables" + String(5, "=")
   ...
   OnlyOneCheckOfTwo 1, 23, 24, IDRENTCONTROLSUB, XXXXX
...
Sub ReviewSalesComp(cmpNo,cmpPg,clBase)
   ...
   If hasText(1, 60) Then
     ...
     OnlyOneCheckOfTwo 1, 75, 76, IDCOMP + IDRENTCONTROLCOMP, XXXXX
...
Sub ReviewSalesComp2(cmpNo,cmpPg,clBase)
   ...
   If hasText(1, 148) Then
     ...
     OnlyOneCheckOfTwo 1, 158, 159, IDCOMP + IDRENTCONTROLCOMP, XXXXX
...
Sub ReviewSalesComp3(cmpNo,cmpPg,clBase)
   ...
   If hasText(1, 231) Then
     ...
     OnlyOneCheckOfTwo 1, 241, 242, IDCOMP + IDRENTCONTROLCOMP, XXXXX
