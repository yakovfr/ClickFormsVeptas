'REV00395.vbs AI Residential Restricted Reviewer Script
...
Sub ReviewSubject
   AddTitle String(5, "=") + "AI FORMS RESIDENTIAL RESTRICTED: " + IDAISAR + String(5, "=") 
...
Sub ReviewREID
   AddTitle String(5, "=") + "AI FORMS RESIDENTIAL RESTRICTED: " + IDAIRE + String(5, "=") 
...
Sub ReviewSPH
   AddTitle String(5, "=") + "AI FORMS RESIDENTIAL RESTRICTED: " + IDAIPH + String(5, "=") 
...
Sub ReviewRC
   AddTitle String(5, "=") + "AI FORMS RESIDENTIAL RESTRICTED: " + IDAIRC + String(5, "=") 
...
Sub ReviewAP
   AddTitle String(5, "=") + "AI FORMS RESIDENTIAL RESTRICTED: " + IDAIAP + String(5, "=")
...
Sub ReviewSW
   AddTitle String(5, "=") + "AI FORMS RESIDENTIAL RESTRICTED: " + IDAISW + String(5, "=")
