'FM00362.vbs 1025 XRentals Reviewer Script
...
Sub ReviewSalesComparison
   AddTitle String(5, "=") + "FNMA 1025 Extra Rentals" + String(5, "=")
   ...
   OnlyOneCheckOfTwo 1, 18, 19, IDRENTCONTROLSUB, "SUBJECT RENT CONTROL: Both Yes and No are Checked"
...
Sub ReviewSalesComp(cmpNo,cmpPg,clBase)
   ...
   If hasText(1, 48) Then
     ...
     OnlyOneCheckOfTwo 1, 53, 54, IDCOMP + IDRENTCONTROLCOMP, IDCOMP + "RENT CONTROL: Both Yes and No are Checked"
...
Sub ReviewSalesComp2(cmpNo,cmpPg,clBase)
   ...
   If hasText(1, 85) Then
     ...
     OnlyOneCheckOfTwo 1, 90, 91, IDCOMP + IDRENTCONTROLCOMP, IDCOMP + "RENT CONTROL: Both Yes and No are Checked"
...
Sub ReviewSalesComp3(cmpNo,cmpPg,clBase)
   ...
   If hasText(1, 122) Then
     ...
     OnlyOneCheckOfTwo 1, 127, 128, IDCOMP + IDRENTCONTROLCOMP, IDCOMP + "RENT CONTROL: Both Yes and No are Checked"
