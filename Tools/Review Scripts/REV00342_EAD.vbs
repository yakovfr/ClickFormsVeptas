'FM0342_EDA.vbs 1004C Additional script for EDA Portal
...
Sub CheckLandUse
   ...
   result = False
   oneUnit = getValue(1,84)
   TwoFourUnit = getValue(1,85)
   MultiFamily = getValue(1,86)
   Commercial = getValue(1,87)
   Other = getValue(1,89)
