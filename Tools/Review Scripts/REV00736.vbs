'FM00736.vbs Non-Lender URAR Reviewer Script
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDSUBJECT + String(5, "=")
...
AddTitle String(5, "=") + "Non-Lender Residential " + ID_CONTRACT_BLOCK + String(5, "=")   
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDNeigh + String(5, "=") 
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDSITE + String(5, "=")
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDIMPROV + String(5, "=")

OnlyOneCheckOfTwo 1, 125, 126, INUNITS2, INUNITS2
Require IDSTORIES, 1, 127
OnlyOneCheckOfThree 1, 128, 129, 130, IDTYPE2, IDTYPE2
OnlyOneCheckOfThree 1, 131, 132, 133, IDEXISTING2, IDEXISTING2
Require IDDESIGN, 1, 134
Require IDYRBLT, 1, 135
Require IDEFFAGE, 1, 136
OnlyOneCheckOfFour 1, 137, 138, 139, 140, IDFOUNDATIONNOCHK, IDFOUNDATIONCHK

If isChecked(1, 139) Then
 Require IDBASEAREA, 1, 141
 Require IDBASEFIN, 1, 142
 Require IDBASEOUTSIDE2, 1, 143
 Require IDSUMP2, 1, 144
End If
...
If hasText(1, 141) Then
 OnlyOneCheckOfTwo 1, 139, 140, IDBASEFULLPART, IDBASEFULLPART
 Require IDBASEFIN, 1, 142
End If

If hasText(1, 142) Then
 OnlyOneCheckOfTwo 1, 139, 140, IDBASEFULLPART, IDBASEFULLPART
 Require IDBASEAREA, 1, 141
End If

Require IDFOUNDATION2, 1, 149
Require IDEXT, 1, 150
Require IDROOFSUF, 1, 151
Require IDGUTTER, 1, 152
Require IDWINDOWTYPE, 1, 153
Require IDFLOOR, 1, 156
Require IDWALLS, 1, 157
Require IDTRIM, 1, 158
Require IDBATHFLOOR, 1, 159
Require IDWAINSCOT, 1, 160

' Attic
checked = GetCheck(1, 165) + GetCheck(1, 162) + GetCheck(1, 166) + GetCheck(1, 163) + GetCheck(1, 167) + GetCheck(1, 164)
If isChecked(1, 161) Then    '  No Attic
  If checked > 0 Then AddRec IDATTICNONE, 1, 161
Else
  If checked = 0 Then AddRec IDATTICNOCK, 1, 161
End If

'  No Doors
OnlyOneCheckOfFour 1, 168, 169, 170, 171, IDHEATTYPE2, XXXXX
If isChecked(1, 171) Then
  Require IDHEATOTHER, 1, 172
End If

Require IDHEATFUEL, 1, 173
OnlyOneCheckOfThree 1, 174, 175, 176, IDCOOLCOND2, XXXXX

If isChecked(1, 176) Then
  Require IDCOOLOTHER, 1, 177
End If

OnlyOneCheckOfSeven 1, 178, 180, 182, 184, 186, 188, 190, IDAMENITIES, XXXXXX

If isChecked(1, 178) Then
  Require IDFIREPLACE2, 1, 179
End If

If isChecked(1, 180) Then
  Require IDPATDECK, 1, 181
End If

If isChecked(1, 182) Then
  Require IDPOOL2, 1, 183
End If

If isChecked(1, 184) Then
  Require IDSTOVES2, 1, 185
End If

If isChecked(1, 186) Then
  Require IDFENCE2, 1, 187
End If

If isChecked(1, 188) Then
  Require IDPORCH2, 1, 189
End If
...
If hasText(1, 179) Then
  Require IDFIREPLACE2CK, 1, 178
End If

If hasText(1, 181) Then
  Require IDPATDECKCK, 1, 180
End If

If hasText(1, 183) Then
  Require IDPOOL2CK, 1, 182
End If

If hasText(1, 185) Then
  Require IDSTOVES2CK, 1, 184
End If

If hasText(1, 187) Then
  Require IDFENCE2CK, 1, 186
End If

If hasText(1, 187) Then
  Require IDPORCH2CK, 1, 188
End If

If hasText(1, 191) Then
  Require IDOTHER2CK, 1, 190
End If

checked = GetTextCheck(1, 193) + GetTextCheck(1, 196) + GetTextCheck(1, 198) + GetTextCheck(1, 200) + GetTextCheck(1, 201) + GetTextCheck(1, 202)
if isChecked(1, 192) then
  if checked > 0 then AddRec IDCARNONE,1,192
else
  if checked = 0 then AddRec IDCARERROR,1,192
end if

If isChecked(1, 193) Then
  Require IDDRIVE, 1, 194
End If

If isChecked(1, 193) Then
  Require IDDRIVE2, 1, 195
End If

If isChecked(1, 196) Then
  Require IDGARNUM, 1, 197
End If

If isChecked(1, 198) Then
  Require IDCARNUM, 1, 199
End If

If hasText(1, 197) Then
  Require IDGARNUM2, 1, 196
End If

If hasText(1, 199) Then
  Require IDCARNUM2, 1, 198
End If

If isChecked(1, 196) Then
  OnlyOneCheckOfThree 1, 200, 201, 202, IDCARERROR2, XXXXX
End If


OnlyOneCheckOfSeven 1, 203, 204, 205, 203, 207, 208, 209, IDAPPLIANCE, XXXXXX

If isChecked(1, 209) Then
  Require IDAPPOTHER, 1, 210
End If

Require IDROOMCNT, 1, 211
Require IDBEDCNT, 1, 212
Require IDBATHCNT, 1, 213
Require IDGLA, 1, 214
Require IDADD, 1, 215
Require IDCOND, 1, 216
OnlyOneCheckOfTwo 1, 217, 218, IDADVERSE2, XXXXX

If isChecked(1, 217) Then
  Require IDADVERSE, 1, 219
End If

OnlyOneCheckOfTwo 1, 220, 221, IDCONFORM2, XXXXX

If isChecked(1, 221) Then
  Require IDCONFORM, 1, 222
End If
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDSALESAPP + String(5, "=")
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDRECON + String(5, "=")
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDCOSTAPP + String(5, "=")
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDINCOME + String(5, "=")
...
AddTitle String(5, "=") + "Non-Lender Residential " + IDPUD + String(5, "=")
