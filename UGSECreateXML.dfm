object CreateUADXML: TCreateUADXML
  Left = 516
  Top = 191
  Width = 666
  Height = 498
  ActiveControl = Panel1
  Caption = 'Create UAD PDF & XML'
  Color = clBtnFace
  ...
  object PageControl: TPageControl
    ...
    object PgOptions: TTabSheet
      ...
      object cbUnparsedUADData: TCheckBox
        Left = 24
        Top = 152
        Width = 353
        Height = 17
        Caption = 'Include unparsed data with the UAD data in the XML file?'
        Ctl3D = True
        ParentCtl3D = False
        TabOrder = 5
        Visible = False
  ...
  object StatusBar: TStatusBar
    ...
    SimplePanel = True
    SimpleText = 
      'Caution: Please make sure the report is UAD compliant before you' +
      ' create a UAD XML file. '
    UseSystemFont = False
  end
