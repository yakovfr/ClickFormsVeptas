...
{ Upon Load all tables, all the addresses will be parsed and    }
{ arranged into Subject, Comp, Sale, Rental and Listing city, st}
{ zip, gps Lon/Lat and proximity fields.                        }
...
*)
  ...
  public
    ...
    property Address1: String read GetSubAddress1 write SetSubAddress1;
    property Address2: String read GetSubAddress2 write SetSubAddress2;

    property Address: String read GetSubAddress write SetSubAddress;
    property City: String read GetSubCity write SetSubCity;
    property State: String read GetSubState write SetSubState;
    property Zip: String read GetSubZip write SetSubZip;
  ...
  private
    ...
    procedure SetCompManager(const Value: TCompMgr);
    function GetCompAddress: String;
    procedure SetCompAddress(const Value: String);
   public
    constructor Create;
    destructor Destroy; override;
    ...
    property Address1: String read GetCompAddress1 write SetCompAddress1;
    property Address2: String read GetCompAddress2 write SetCompAddress2;
    property Address: String read GetCompAddress write SetCompAddress;
    property City: String read GetCompCity write SetCompCity;
    property State: String read GetCompState write SetCompState;
    property Zip: String read GetCompZip write SetCompZip;
    property GPSLong: String read FGPSLong write FGPSLong;
    property GPSLat: String read FGPSLat write FGPSLat;
    property Proximity: String read GetCompProximity write SetCompProximity;
  end;
  ...
  public
    ...
    property HasSubjectAddress: Boolean;
...
function TCompMgr3.GetHasSomeComps: Boolean;
begin
  result := (Sales.count > 0) or (Rentals.count > 0) or (Listings.count > 0);
end;

procedure TCompMgr3.LoadAllComparableTables;
var
  i,f,p,t: Integer;
  AComp: TComparable;
begin
...
procedure TCompMgr3.LoadSubjectTableData(kTableType: Integer);
var
  f,p,t: Integer;
  ASub: TSubject;
begin
...
procedure TCompMgr3.LoadAllSubjectTableData;
begin
...
procedure TCompMgr3.SetContainer(const Value: TContainer);
begin
  FDoc := Value;
  if FDoc <> nil then
    begin
...
function TComparable.GetCompAddress: String;
begin
//
end;

procedure TComparable.SetCompAddress(const Value: String);
begin
//
end;
