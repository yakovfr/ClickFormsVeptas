...
//  >Import : http://webservices.appraisalworld.com/secure/ws/awsi/AwsiAccessServer.php?wsdl:0
// Encoding : ISO-8859-1
// Version  : 1.0
// (8/14/2014 4:03:09 PM - - $Rev: 10138 $)
// ************************************************************************ //

unit AwsiAccessServer;
...
type
  ...
  clsOffsetPoint       = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsDisplayRectangle  = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsResults           = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetExistingOrderData = class;              { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetOrderData      = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsUpdateMemberInformationResponse = class;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  ...
  clsGetClientVersionResponse = class;          { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetClientVersionData = class;              { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetNewOrderResponse = class;               { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetOrder2Data     = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetNewOrder2Response = class;              { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetOrder3Data     = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetNewOrder3Response = class;              { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetExistingOrderResponse = class;          { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAddLenderReferenceResponse = class;        { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetSecurityTokenResponse = class;          { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetSecurityTokenData = class;              { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetSignatureDetailsData = class;           { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetSignatureDetailsResponse = class;       { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetSignatureLastChangeDateResponse = class;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsInitializeConnectionResponse = class;      { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsInitializeConnectionData = class;          { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsProductListItem   = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsPromotionListItem = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsIsMemberResponseData = class;              { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsIsMemberResponse  = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetMemberInformationResponse = class;      { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetMemberInformationData = class;          { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsLicenseItem       = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetMemberInformation2Data = class;         { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetMemberInformation2Response = class;     { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsSendMessageResponse = class;               { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsSendExternalEmailResponse = class;         { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetClickformsSecurityTokenResponseData = class;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetClickformsSecurityTokenResponse = class;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetMembershipLevelResponseData = class;    { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetMembershipLevelResponse = class;        { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAttachmentListItem = class;                { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsToListItem        = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAccessCredentials = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAwsiOrderDetailsRequest = class;           { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAddressDetails    = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsNewOrderDetails   = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsMemberInformationCredentials = class;      { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAcknowledgement   = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetClientVersionRequest = class;           { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAwsiNewOrderDetailsRequest = class;        { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAwsiNewOrder2DetailsRequest = class;       { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAwsiNewOrder3DetailsRequest = class;       { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsLenderReferenceDetails = class;            { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsAwsiAccessDetailsRequest = class;          { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsIsMemberCredentials = class;               { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetMemberInformationCredentials = class;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsSendMessageCredentials = class;            { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsSendMessageRequest = class;                { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsSendExternalEmailRequest = class;          { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsUpdateMemberInformationData = class;       { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsUpdateMemberInformationCredentials = class;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsSignatureUpdateDetails = class;            { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsUpdateMemberInformation2Data = class;      { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsGetClickformsSecurityTokenCredentials = class;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsLevelAccessCredentials = class;            { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsOpenOrderListItem = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsCompanyListItem   = class;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  ...
  clsCompanyList = array of clsCompanyListItem;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsProductList = array of clsProductListItem;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsOpenOrderList = array of clsOpenOrderListItem;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  clsPromotionList = array of clsPromotionListItem;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  ...
  clsLicenseItemArray = array of clsLicenseItem;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  ...
  clsAttachmentList = array of clsAttachmentListItem;   { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  ...
  clsToList  = array of clsToListItem;          { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  ...
  // ************************************************************************ //
  // XML       : clsLevelAccessCredentials, global, <complexType>
  // Namespace : http://webservices.appraisalworld.com/secure/ws/WSDL
  // ************************************************************************ //
  clsLevelAccessCredentials = class(TRemotable)
  private
    FCustomerId: Integer;
  ...
  key             = WideString;      { "http://webservices.appraisalworld.com/secure/ws/WSDL"[Alias] }
  ArrayOfString = array of key;                 { "http://webservices.appraisalworld.com/secure/ws/WSDL"[GblCplx] }
  ...
  // URL       : http://webservices.appraisalworld.com/secure/ws/awsi/AwsiAccessServer.php
  // ************************************************************************ //
  AwsiAccessServerPortType = interface(IInvokable)
  ['{92286E94-6CA4-94D5-F323-0DC0C7D19113}']
    ...
    function  AwsiAccessService_GetMembershipLevel(const LevelAccessCredentials: clsLevelAccessCredentials): clsGetMembershipLevelResponse; stdcall;
  end;
...
const
  defWSDL = 'http://webservices.appraisalworld.com/secure/ws/awsi/AwsiAccessServer.php?wsdl';
  defURL  = 'http://webservices.appraisalworld.com/secure/ws/awsi/AwsiAccessServer.php';
...
initialization
  ...
  InvRegistry.RegisterExternalMethName(TypeInfo(AwsiAccessServerPortType), 'AwsiAccessService_GetMembershipLevel', 'AwsiAccessService.GetMembershipLevel');
  RemClassRegistry.RegisterXSClass(clsOffsetPoint, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsOffsetPoint');
  RemClassRegistry.RegisterXSClass(clsDisplayRectangle, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsDisplayRectangle');
  ...
  RemClassRegistry.RegisterXSClass(clsGetExistingOrderData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetExistingOrderData');
  RemClassRegistry.RegisterXSClass(clsGetOrderData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetOrderData');
  RemClassRegistry.RegisterXSClass(clsUpdateMemberInformationResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsUpdateMemberInformationResponse');
  ...
  RemClassRegistry.RegisterXSClass(clsGetClientVersionResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetClientVersionResponse');
  RemClassRegistry.RegisterXSClass(clsGetClientVersionData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetClientVersionData');
  RemClassRegistry.RegisterXSClass(clsGetNewOrderResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetNewOrderResponse');
  RemClassRegistry.RegisterXSClass(clsGetOrder2Data, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetOrder2Data');
  RemClassRegistry.RegisterXSClass(clsGetNewOrder2Response, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetNewOrder2Response');
  RemClassRegistry.RegisterXSClass(clsGetOrder3Data, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetOrder3Data');
  RemClassRegistry.RegisterXSClass(clsGetNewOrder3Response, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetNewOrder3Response');
  RemClassRegistry.RegisterXSClass(clsGetExistingOrderResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetExistingOrderResponse');
  RemClassRegistry.RegisterXSClass(clsAddLenderReferenceResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAddLenderReferenceResponse');
  RemClassRegistry.RegisterXSClass(clsGetSecurityTokenResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetSecurityTokenResponse');
  RemClassRegistry.RegisterXSClass(clsGetSecurityTokenData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetSecurityTokenData');
  RemClassRegistry.RegisterXSClass(clsGetSignatureDetailsData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetSignatureDetailsData');
  RemClassRegistry.RegisterXSClass(clsGetSignatureDetailsResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetSignatureDetailsResponse');
  RemClassRegistry.RegisterXSClass(clsGetSignatureLastChangeDateResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetSignatureLastChangeDateResponse');
  RemClassRegistry.RegisterXSClass(clsInitializeConnectionResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsInitializeConnectionResponse');
  RemClassRegistry.RegisterXSInfo(TypeInfo(clsCompanyList), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsCompanyList');
  RemClassRegistry.RegisterXSInfo(TypeInfo(clsProductList), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsProductList');
  RemClassRegistry.RegisterXSInfo(TypeInfo(clsOpenOrderList), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsOpenOrderList');
  RemClassRegistry.RegisterXSInfo(TypeInfo(clsPromotionList), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsPromotionList');
  RemClassRegistry.RegisterXSClass(clsInitializeConnectionData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsInitializeConnectionData');
  RemClassRegistry.RegisterXSClass(clsProductListItem, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsProductListItem');
  RemClassRegistry.RegisterXSClass(clsPromotionListItem, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsPromotionListItem');
  RemClassRegistry.RegisterXSClass(clsIsMemberResponseData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsIsMemberResponseData');
  RemClassRegistry.RegisterXSClass(clsIsMemberResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsIsMemberResponse');
  RemClassRegistry.RegisterXSClass(clsGetMemberInformationResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetMemberInformationResponse');
  RemClassRegistry.RegisterXSClass(clsGetMemberInformationData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetMemberInformationData');
  RemClassRegistry.RegisterXSClass(clsLicenseItem, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsLicenseItem');
  RemClassRegistry.RegisterXSInfo(TypeInfo(clsLicenseItemArray), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsLicenseItemArray');
  RemClassRegistry.RegisterXSClass(clsGetMemberInformation2Data, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetMemberInformation2Data');
  RemClassRegistry.RegisterXSClass(clsGetMemberInformation2Response, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetMemberInformation2Response');
  RemClassRegistry.RegisterXSClass(clsSendMessageResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsSendMessageResponse');
  RemClassRegistry.RegisterXSClass(clsSendExternalEmailResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsSendExternalEmailResponse');
  RemClassRegistry.RegisterXSClass(clsGetClickformsSecurityTokenResponseData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetClickformsSecurityTokenResponseData');
  RemClassRegistry.RegisterXSClass(clsGetClickformsSecurityTokenResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetClickformsSecurityTokenResponse');
  RemClassRegistry.RegisterXSClass(clsGetMembershipLevelResponseData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetMembershipLevelResponseData');
  RemClassRegistry.RegisterXSClass(clsGetMembershipLevelResponse, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetMembershipLevelResponse');
  RemClassRegistry.RegisterXSClass(clsAttachmentListItem, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAttachmentListItem');
  RemClassRegistry.RegisterXSInfo(TypeInfo(clsAttachmentList), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAttachmentList');
  RemClassRegistry.RegisterXSClass(clsToListItem, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsToListItem');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(clsToListItem), 'Name_', 'Name');
  RemClassRegistry.RegisterXSInfo(TypeInfo(clsToList), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsToList');
  RemClassRegistry.RegisterXSClass(clsAccessCredentials, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAccessCredentials');
  RemClassRegistry.RegisterXSClass(clsAwsiOrderDetailsRequest, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAwsiOrderDetailsRequest');
  RemClassRegistry.RegisterXSClass(clsAddressDetails, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAddressDetails');
  RemClassRegistry.RegisterXSClass(clsNewOrderDetails, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsNewOrderDetails');
  RemClassRegistry.RegisterXSClass(clsMemberInformationCredentials, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsMemberInformationCredentials');
  ...
  RemClassRegistry.RegisterXSClass(clsGetClientVersionRequest, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetClientVersionRequest');
  RemClassRegistry.RegisterXSClass(clsAwsiNewOrderDetailsRequest, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAwsiNewOrderDetailsRequest');
  RemClassRegistry.RegisterXSClass(clsAwsiNewOrder2DetailsRequest, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAwsiNewOrder2DetailsRequest');
  RemClassRegistry.RegisterXSClass(clsAwsiNewOrder3DetailsRequest, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAwsiNewOrder3DetailsRequest');
  RemClassRegistry.RegisterXSClass(clsLenderReferenceDetails, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsLenderReferenceDetails');
  RemClassRegistry.RegisterXSClass(clsAwsiAccessDetailsRequest, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsAwsiAccessDetailsRequest');
  RemClassRegistry.RegisterXSClass(clsIsMemberCredentials, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsIsMemberCredentials');
  RemClassRegistry.RegisterXSClass(clsGetMemberInformationCredentials, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetMemberInformationCredentials');
  RemClassRegistry.RegisterXSClass(clsSendMessageCredentials, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsSendMessageCredentials');
  RemClassRegistry.RegisterXSClass(clsSendMessageRequest, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsSendMessageRequest');
  RemClassRegistry.RegisterXSClass(clsSendExternalEmailRequest, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsSendExternalEmailRequest');
  RemClassRegistry.RegisterXSClass(clsUpdateMemberInformationData, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsUpdateMemberInformationData');
  RemClassRegistry.RegisterXSClass(clsUpdateMemberInformationCredentials, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsUpdateMemberInformationCredentials');
  RemClassRegistry.RegisterXSClass(clsSignatureUpdateDetails, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsSignatureUpdateDetails');
  RemClassRegistry.RegisterXSClass(clsUpdateMemberInformation2Data, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsUpdateMemberInformation2Data');
  RemClassRegistry.RegisterXSClass(clsGetClickformsSecurityTokenCredentials, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsGetClickformsSecurityTokenCredentials');
  RemClassRegistry.RegisterXSClass(clsLevelAccessCredentials, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsLevelAccessCredentials');
  RemClassRegistry.RegisterXSInfo(TypeInfo(key), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'key');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOfString), 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'ArrayOfString');
  RemClassRegistry.RegisterXSClass(clsOpenOrderListItem, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsOpenOrderListItem');
  RemClassRegistry.RegisterXSClass(clsCompanyListItem, 'http://webservices.appraisalworld.com/secure/ws/WSDL', 'clsCompanyListItem');
