...
begin
  ...
  begin
    // change window owner to active form
    hWndOwner := GetWindow(Wnd, GW_OWNER);
    if (hWndOwner = Application.Handle) and Assigned(Screen.ActiveForm) then
      begin
        SetWindowLong(Wnd, GWL_HWNDPARENT, Screen.ActiveForm.Handle);
        SetWindowPos(Wnd, HWND(-1), 0, 0, 0, 0, SWP_NOSIZE);
      end;
