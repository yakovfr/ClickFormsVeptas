...
const
  ...
  SEQUENCE_IDENTIFIER_ATTRIBUTE_NAMES : array[0..2] of string = ('PropertySequenceIdentifier', 'ListingSequenceIdentifier', '_SequenceIdentifier');
  // V6.8.0
...
//JW      else
//JW        raise EMISMOTranslationMissingMappingError.Create('No mapping present for CellID ' + IntToStr(ACellID));
    end;
end;
