'FM00341_PCV.vbs URAR Reviewer Script
' PCV rules:
...
' 11/04/2014: PCV rules
' PCV Rules #22: Lender/Client name is not "PCV MURCOR".  Correct Lender/Client Name.  Must be "PCV MURCOR".
...
'PCVAC-25: Email address is Blank.  Provide Email address.
 ...
 ' End If
  ...
  'PCV #48: DateDiff will return # of days that are different between the 2 dates
  RECAPPCERTLICEXPDAT = "**Expiration Date of Cert/Lic is before the Effective Date of the Appraisal.  Provide correct Exp. Date."
  lDate  = GetText(3,18)
  eDate = GetText(3,12)
  if (lDate<>"") and (eDate<>"") then
