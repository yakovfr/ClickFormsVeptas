'FM00352.vbs 2090 Reviewer Script
' PCV rules:
...
Dim NumLicenses
  ...
  AddTitle String(5, "=") + "FNMA 2090 " + IDAPPCERT + String(5, "=")
 ...
 ' Show warning if Expiration date already today's date  
  ...
  Require IDCERTLENDEREMAILADD, 3, 26
    ...
    OnlyOneCheckOfThree 3, 38, 39, 41, "", "SUP APPRAISER INSP SUBJECT: More than one checked"
    OnlyOneCheckOfTwo 3, 43, 44, "", "SUP APPRAISER INSP COMPS: More than one checked"
  ...
  If hasText(3, 27) Then
    ...
    OnlyOneCheckOfThree 3, 38, 39, 41, IDCERTSUBINSPECT, "SUP APPRAISER INSP SUBJECT: More than one checked"
    ...
    End If
    OnlyOneCheckOfTwo 3, 43, 44, IDCERTCOMPINSPECT, "SUP APPRAISER INSP COMPS: More than one checked"
