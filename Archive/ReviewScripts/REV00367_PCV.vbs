'FM00367_PCV.vbs 1073 and 1075 Extra Comps Reviewer Script
...
'isMatch = False
'If (GetText(1, 54)<> "") and (strComp(GetText(1,33), GetText(1,85)) = 0) Then   
'   isMatch = True
'End If
'If (GetText(1, 123)<>"") and (strComp(GetText(1,33), GetText(1,154)) = 0) Then   
'   isMatch = True
'End If
'If (GetText(1, 192)<>"") and (strComp(GetText(1,33), GetText(1,223)) = 0) Then   
'   isMatch = True
'End If
'If not isMatch Then
'   AddRec  GSU_AG_QUAL, 1, 33
'ENd If
...
'isMatch = False
'If (GetText(1, 54)<> "") and (strComp(GetText(1,35), GetText(1,89)) = 0) Then   
'   isMatch = True
'End If
'If (GetText(1, 123)<>"") and (strComp(GetText(1,35), GetText(1,158)) = 0) Then   
'   isMatch = True
'End If
'If (GetText(1, 192)<>"") and (strComp(GetText(1,35), GetText(1,227)) = 0) Then   
'   isMatch = True
'End If
'If not isMatch Then
'   AddRec  GSU_AG_COND, 1, 35
'ENd If
...
'PCV #26: Make sure subject GLA is bracketed by  comp. gla.
'gSub = GetValue(1,39)
'gComp1 = GetValue(1,96)
'gComp2 = GetValue(1,165)
'gComp3 = GetValue(1,234)
